...
public class SavedBookAdapter extends RecyclerView.Adapter<SavedBookAdapter.TasksViewHolder> {
    ...
    public SavedBookAdapter(Context mCtx, List<Book> bookList) {
        this.mCtx = mCtx;
        this.bookList = bookList;
        this.listener = (SavedBooksActivity)mCtx;
    }
    ...
    @Override
    public void onBindViewHolder(@NonNull SavedBookAdapter.TasksViewHolder holder, int position) {
